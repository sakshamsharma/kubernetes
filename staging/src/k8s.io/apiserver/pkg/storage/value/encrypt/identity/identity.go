...
type encryptIdentityTransformer struct{}
...
var EncryptIdentityTransformer value.Transformer = encryptIdentityTransformer{}

// TransformFromStorage returns the input bytes if the data is not encrypted
func (encryptIdentityTransformer) TransformFromStorage(b []byte, context value.Context) ([]byte, bool, error) {
...
func (encryptIdentityTransformer) TransformToStorage(b []byte, context value.Context) ([]byte, error) {
	return b, nil
}
