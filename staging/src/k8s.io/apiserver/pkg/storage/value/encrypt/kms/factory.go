...
// NewFactoryWithService returns a Factory instance which always uses the provided KMS service.
// Used for running unit tests.
func NewFactoryWithService(gkmsService value.KMSService) *Factory {
	return &Factory{
