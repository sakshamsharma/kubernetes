...
type GKMSConfig struct {
	// projectID is the GCP project which hosts the key to be used. It is automatically set
	// to your project if you are running Kubernetes on GKE/GCE.
	// +optional
	ProjectID string `json:"projectID,omitempty"`
	// location is the location of the hosted key to be used. The default value is "global".
	// +optional
