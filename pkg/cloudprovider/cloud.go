...
type Interface interface {
	...
	// KeyManagementService provides a named key management service supported by the cloud. Returns nil
	// without an error if key management providers are not supported by the cloud. Returns an error if the named provider
	// is not supported by the cloud.
	KeyManagementService(name string) (KeyManagementServices, error)
}
...
// KeyManagementServices allows encrypting and decrypting data using an external Key Management Service.
type KeyManagementServices interface {
